...
from app.services import document_ingestion_service, vector_store_service
...
def handle_upload(
    ...
    """Save uploaded file to disk, persist metadata, and schedule ingestion."""
    # Validate file type
    ...
    background_tasks.add_task(document_ingestion_service.process_document, doc.id)
...
def handle_delete(session: Session, document_id: UUID) -> dict:
    """Delete document chunks from Qdrant, file from disk, and record from DB."""
